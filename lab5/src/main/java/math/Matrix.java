...
public class Matrix {
    ...
    public static Matrix solveWithLUP(Matrix A, Matrix b) {
        try {
            Matrix P = A.LUP();
            Matrix y = A.forwardSubstitution(P.multiply(b));
            return A.backwardSubstitution(y);
        } catch(Exception ex) {
            System.out.println("Failed to solve with LUP, division with 0 occurred. \n");
            return new Matrix(b.getColumns(), b.getRows(), 0);
        }

    }

    public static void solveAndPrintWithLUP(Matrix A, Matrix b) {
        try {
            Matrix P = A.LUP();
            Matrix y = A.forwardSubstitution(P.multiply(b));
    ...
    public static void solveAndPrintWithLU(Matrix A, Matrix b) {
        try {
            A.LU();
    ...
    public static void main(String[] args) {
        ...
        solveAndPrintWithLU(A.copy(), b);
        solveAndPrintWithLUP(A.copy(), b);
