...
public class Matrix {
    ...
    private void divideElement(int i, int j, double divider) {
        setElement(i, j, getElement(i, j) /  divider);
    }

    private void subtractElement(int i, int j, double subtrahend) {
        setElement(i, j, getElement(i, j) - subtrahend);
    }
    ...
    public void printToConsole() {
        for(int i = 0; i < m; i++) {
            System.out.println(rowAsString(i));
        }
        System.out.println();
    }
