...
public class Simplex {
    ...
    public static Matrix search(Matrix x0, Function<Matrix, Double> f, double sigma) {
        return search(x0, f, DEFAULT_ALPHA, DEFAULT_BETA, DEFAULT_GAMMA, sigma, DEFAULT_PRECISION);
    }

    public static Matrix search(Matrix x0, Function<Matrix, Double> f, double alpha, double beta, double gamma, double sigma, double e) {
    ...
    private static int[] findLowAndHigh(Matrix x, Function<Matrix, Double> f) {
    ...
    private static boolean checkReflectionIsMax(Matrix x, Matrix xr, int h, Function<Matrix, Double> f) {
        for (int j = 0; j < x.getColumns(); j++) {
    ...
    private static boolean checkSimplexStoppingCriterion(Matrix x, Matrix xc, Function<Matrix, Double> f, double e) {
        double rootSum = 0;
        for (int j = 0; j < x.getColumns(); j++) {
